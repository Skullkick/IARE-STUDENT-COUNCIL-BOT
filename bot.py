...
async def recieve_inputs(bot,message):
    chat_id = message.chat.id
    # print(await sqlitedb.check_permission(chat_id,edit_events=True))
    if await sqlitedb.check_permission(chat_id,clubs=True) is True:
...
async def main(bot):
    ...
    # await sqlitedb.delete_temp_club_by_chat_id(1767667538)
    # print(await sqlitedb.get_club_names_and_indexes())
    # await sqlitedb.delete_temp_enforcement_team_member(1767667538)
    # print(await sqlitedb.store_enforcement_team_details(chat_id=124, name="jhbd"))
    # print(await club_event_keyboards.event_buttons(chat_id=1767667538))
    # print(await sqlitedb.get_event_id_by_name(event_name="Helo"))
    # await sqlitedb.set_permissions(chat_id=1234,proposal_form=4)
    # print(await sqlitedb.check_permission(chat_id=1234,proposal_form=True))
