...
# async def perform_sync_event_table():
#     event_data = await PostgresSQL.retrive_events_info()
...
if __name__ == "__main__":
    asyncio.run(test_sync_databases())
    # asyncio.run(sqlitedb.initialize_sqlite_database())
...
# # Function to create necessary tables in SQLite if they don't exist
...
#     await perform_sync_core_team_table_info()
#     await perform_sync_enforcement_team_info()
#     await perform_sync_permissions_table()
...
#             core_member_index INTEGER PRIMARY KEY,
#             core_name TEXT,
#             core_member_name TEXT,
#             core_member_chat_id BIGINT,
#             tasks JSON
...
# # Testing function to ensure everything works as expected
# async def test_sync_databases():
#     # await create_all_tables()  # Ensure tables are created
#     await sync_databases()     # Perform data sync from PostgreSQL to SQLite
